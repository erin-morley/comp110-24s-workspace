...
def add_by_kind(plants_by_kind: dict[str, list], plant_kind: str, plant: str) -> None:
...
def look_up_by_kind_and_date(plants_by_kind: dict[str, list[str]], plants_by_date: dict[str, list[str]], plant_kind: str, month: str) -> str:
