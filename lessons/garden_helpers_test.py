...
from lessons.garden_helpers import look_up_by_kind_and_date
...
def test_look_up_by_kind_and_date() -> None:
    ...
    look_up_by_kind_and_date(by_kind, by_date, "flowers", "May")
    assert "flowers to plant in May: ['rose']"

def test_look_up_by_kind_and_date2() -> None:
    ...
    look_up_by_kind_and_date(by_kind, by_date, "fruit", "May")
